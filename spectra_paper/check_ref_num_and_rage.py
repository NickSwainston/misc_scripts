...
# Grab all the catalogue yamls (this for garra)
CAT_YAMLS = glob.glob("/pawsey/mwa/software/python3/pulsar_spectra/master/lib/python3.8/site-packages/pulsar_spectra/catalogue_papers/*yaml")
# sort by year
CAT_YAMLS.sort(key = lambda x: x.split("/")[-1].split(".")[0].split("_")[-1])
