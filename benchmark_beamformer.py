...
def plot_benchmarks(max_pointings):
    ...
    arm_mpb_times = np.array([8.110399999999998, 4.9128, 3.6613999999999995, 3.850090909090908, 3.0969599999999997, 3.2958666666666665, 3.165042857142857, 2.6165999999999996, 3.1503111111111113, 2.819079999999999, 2.883272727272727, 3.2305, 2.6532923076923076, 2.648342857142857, 2.889706666666666])
    arm_mpb_t_std = np.array([1.8372729007961772, 0.9849470007496414, 0.7617843001795193, 0.4998328256064411, 0.3490316295122836, 0.4267618018936976, 0.3407655460091861, 0.24979979983979167, 0.1516734634211695, 0.31109864930597164, 0.30045731755013316, 0.05030000000000001, 0.29517534894909303, 0.18153397163380425, 0.1761677907248909])
    arm_orig_times = np.array([9.48]*15)
